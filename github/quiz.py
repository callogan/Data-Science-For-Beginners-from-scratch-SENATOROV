...
#
# Файл .gitignore должен находиться в корне репозитория (или в любом подкаталоге — Git будет учитывать его на соответствующем уровне). Его можно редактировать вручную или создать автоматически при инициализации репозитория с помощью шаблонов (например, на GitHub при создании репо).
