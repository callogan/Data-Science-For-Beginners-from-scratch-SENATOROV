...
# 4. Ознакомился с использованием калькулятора для вычисления значений пуассоновского
# распределения.
# 5. Изучил понятие и природу непрерывных случайных величин (включая функцию их распределения,
# свойства плотности распределения).
# 6. Рассмотрел понятия пределов и непрерывности функций, а также понятие производной.
